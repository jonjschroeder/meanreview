...
//I want to call the connect function for mongoose so I can connect to database.  I should put inside the connect function the location of the database, so I will create a config file and put the database in that.  Now I am referencing the key database in the config file.  
mongoose.connect(config.database);

//Something to let us know that we are connected.
//remember to use sudo mongod  
